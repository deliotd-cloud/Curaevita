...
export const companions: Companion[] = [
  ...
  },
  {
    ...
    intro: 'ADHD Companion is in internal testing as a quick medication and daily-pattern tracker. It records what you enter without estimating medication levels, calculating doses or replacing instructions from your prescriber.',
  ...
  },
  {
    ...
    intro: 'Gut Companion is in internal testing as a digestive symptom and food diary. It helps organise timing and observations without diagnosing a condition, proving a trigger or prescribing an elimination diet.',
  ...
  },
  {
    ...
    intro: 'Migraine Companion is in internal testing as a private attack and medication diary. It records your observations and optional weather context without diagnosing migraine or proving that a factor caused an attack.',
